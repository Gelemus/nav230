report 50174 "Detailed Performance by Prod"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Detailed Performance by Prod.rdl';
    ...
    var
        ...
        ReportTitle: Label 'Detailed  Performance by Product Class';
