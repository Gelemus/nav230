report 50233 "Account Schedules Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Account Schedules Report.rdl';
    AdditionalSearchTerms = 'financial reporting,income statement,balance sheet';
    ApplicationArea = Basic, Suite;
    Caption = 'Account Schedules Report';
    ...
    dataset
    {
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                column(ShowGlAccount; ShowGlAccount)
                {
                }
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    column(GLAccount_AccScheduleLine; "Acc. Schedule Line"."G/L Account")
                    {
                    }
