report 52204 "Employees Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Employees Statement.rdl';
        ...
        dataitem(Employee; Employee)
        {
            ...
            dataitem("Employee Ledger Entry"; "Employee Ledger Entry")
            {
                ...
                begin
                    ...
                    Totals := Totals + "Employee Ledger Entry"."Debit Amount" - "Employee Ledger Entry"."Credit Amount";
                end;
            ...
            begin
                ...
                EmployeeLedgerEntry.Reset;
                EmployeeLedgerEntry.SetRange("Employee No.", Employee."No.");
                EmployeeLedgerEntry.SetFilter("Posting Date", EmpDateFilter);
                if EmployeeLedgerEntry.FindSet then begin
                    repeat
                        EmployeeLedgerEntry.CalcFields("Amount (LCY)");
                        EmpBalanceLCY := EmpBalanceLCY + EmployeeLedgerEntry."Amount (LCY)";
                    until EmployeeLedgerEntry.Next = 0;
                end;


                //Calculate Running Balance
                Totals := Totals + StartBalanceLCY + EmpBalanceLCY;
