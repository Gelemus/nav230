report 50064 "Marketing Plan Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Marketing Plan Report.rdl';
    ...
    dataset
    {
        dataitem("Employee Account Invoice2"; "Employee Account Invoice2")
        {
            ...
            {
                // DataItemLink = Field52137008=FIELD("Loan Account No.");
                ...
                dataitem("To-do"; "To-do")
                {
                    ...
                    column(EstimatedCost_Todo; "To-do"."Team To-do")
                    {
                    }
                }
                dataitem("Employee Interest Accrual"; "Employee Interest Accrual")
                {
                    ...
                    column(ActivityDescription_MarketingActivities; "Employee Interest Accrual"."Account No.")
                    {
                    }
                    column(Type_MarketingActivities; "Employee Interest Accrual"."Account No.")
                    {
                    }
                    ...
                    column(DateCreated_MarketingActivities; "Employee Interest Accrual"."Account No.")
                    {
                    }
                    column(TimeCreated_MarketingActivities; "Employee Interest Accrual"."Account No.")
                    {
                    }
                }
