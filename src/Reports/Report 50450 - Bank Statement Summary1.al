report 50450 "Bank Statement Summary1"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Bank Statement Summary1.rdl';
    ...
    dataset
    {
        dataitem("Bank Acc. Reconciliation Line"; "Bank Acc. Reconciliation Line")
        {
            ...
            column(DataItem50; Prepared_by_Date_Lbl)
            {
            }
            column(Reviewed_by; Reviewed_by_Date_Lbl)
            {
            }
            ...
            column(Approved_by; Approved_by_Date_Lbl)
            {
            }
            ...
            column(TotalBalanceNow; TotalBalanceNow)
            {
            }
            column(NoofDebits; NoofDebits)
            {
            }
            column(NoofCredits; NoofCredits)
            {
            }
            ...
            begin
                if "Bank Acc. Reconciliation Line"."Statement Amount" > 0 then begin
                    TotalDebits += "Bank Acc. Reconciliation Line"."Statement Amount";
                    NoofDebits += 1;
                end else begin
                    TotalCredits += "Bank Acc. Reconciliation Line"."Statement Amount";
                    NoofCredits += 1;
                end;
                TotalBalanceNow += "Bank Acc. Reconciliation Line"."Statement Amount";
            end;
            ...
            begin
                ...
                BankAccReconciliation.SetRange("Bank Account No.", VarBankRec."Bank Account No.");
                BankAccReconciliation.SetRange("Statement No.", VarBankRec."Statement No.");
                BankAccReconciliation.SetRange("Statement Type", VarBankRec."Statement Type");
                if BankAccReconciliation.FindFirst then begin
                    BankStatBalance := BankAccReconciliation."Statement Ending Balance";
                    BankLastBalance := BankAccReconciliation."Balance Last Statement";
                ...
                TotalBalanceNow := BankLastBalance;
            end;
        }
    }
    ...
    var
        ...
        Prepared_by_Date_Lbl: Label 'Prepared by:........................................                                        Date...............................................';
        Reviewed_by_Date_Lbl: Label 'Reviewed by:.......................................                                        Date...............................................';
        ...
        Approved_by_Date_Lbl: Label 'Approved by:.........................................                                      Date................................................';
        DepositDiff: Decimal;
