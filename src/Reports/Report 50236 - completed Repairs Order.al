report 50236 "completed Repairs Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/completed Repairs Order.rdl';
    ...
    dataset
    {
        dataitem("Transport Request"; "Transport Request")
        {
            ...
            RequestFilterFields = "Posting Date", "Vehicle No", "Supplier No";
            ...
            trigger OnAfterGetRecord()
            begin
                /*SETFILTER("Transport Request"."Request Date",'%1..%2',StartDate,EndDate);
                  StartDate := "Transport Request".GETRANGEMIN("Request Date");
                  EndDate := "Transport Request".GETRANGEMAX("Request Date");
                
                IF "Transport Request"."Request Date"< StartDate THEN
                  CurrReport.SKIP;*/
