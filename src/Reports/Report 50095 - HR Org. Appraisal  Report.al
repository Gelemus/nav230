report 50095 "HR Org. Appraisal  Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/HR Org. Appraisal  Report.rdl';

    dataset
    {
        dataitem("HR Employee Appraisal Header"; "HR Employee Appraisal Header")
        {
            dataitem("Organization Appraisal Lines"; "Organization Appraisal Lines")
            {
