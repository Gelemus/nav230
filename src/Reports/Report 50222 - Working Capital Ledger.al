report 50222 "Working Capital Ledger"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Working Capital Ledger.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            RequestFilterFields = "No.", "Search Name", "Income/Balance", "Debit/Credit", "Date Filter", "Working Capital Ledger";
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    column(Payee_GLEntry; "G/L Entry".Payee)
                    {
                    }
                    ...
                    begin
                        ...
                        MonthText := Format("G/L Entry"."Posting Date", 0, '<Month Text> <Year4>');
                    end;
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'Working Capital Ledger Report';
