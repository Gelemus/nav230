report 50229 "Remittance Advice"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Remittance Advice.rdl';
    ...
    dataset
    {
        dataitem("Payment Header"; "Payment Header")
        {
            ...
            column(Tel; CompanyInfo."Telephone No.")
            {
            }
            ...
            dataitem("Payment Line"; "Payment Line")
            {
                ...
                begin
                    ...
                    PurchInvHeader.SetRange("No.", "Payment Line"."Applies-to Doc. No.");
                ...
                begin
                    ...
                    if i = 1 then begin
                        ...
                        if EmployeeRecI.FindFirst then begin
                            PreparedByCaption := 'Prepared by Payable Accountant: ' + ' ' + EmployeeRecI."First Name" + ' ' + EmployeeRecI."Last Name";
                        ...
                        ApprovedByCaption := 'Examined by Financial Accountant: ';
                    ...
                    if i = 2 then begin
                        ApprovedByCaption := 'Approved by Finance Manager: ';
                        UserSetupRec.Reset;
                        UserSetupRec.SetRange("User ID", "Approval Entry"."Approver ID");
                        if UserSetupRec.FindFirst then
                            UserSetupRec.CalcFields(Signature);
                        ...
                        ApprovedByCaption := 'Authorized By Managing Director:  ';
                        UserSetupRec.Reset;
                        UserSetupRec.SetRange("User ID", "Approval Entry"."Approver ID");
                        if UserSetupRec.FindFirst then
                            UserSetupRec.CalcFields(Signature);
            ...
            begin
                ...
                CheckReport.FormatNoText(NumberText, ("Payment Header"."Net Amount"), "Payment Header"."Currency Code");
