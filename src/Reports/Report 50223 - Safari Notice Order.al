report 50223 "Safari Notice Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Safari Notice Order.rdl';

    dataset
    {
        dataitem("Transport Request"; "Transport Request")
        {
            column(PrivatePublicOfficialCar_TransportRequest; "Transport Request"."Private/Public/Official Car")
            {
            }
            column(VehicleDescription_TransportRequest; "Transport Request"."Vehicle Description")
            {
            }
            column(FinancialYear_TransportRequest; "Transport Request"."Financial Year")
            {
            }
            column(TripPlannedStartDate_TransportRequest; "Transport Request"."Trip Planned Start Date")
            {
            }
            column(TripPlannedEndDate_TransportRequest; "Transport Request"."Trip Planned End Date")
            {
            }
            column(Destination_TransportRequest; "Transport Request".Destination)
            {
            }
            column(ReasonforTravel_TransportRequest; "Transport Request"."Reason for Travel")
            {
            }
            ...
            column(Designation_TransportRequest; "Transport Request".Designation)
            {
            }
            column(WhereStationed_TransportRequest; "Transport Request"."Where Stationed")
            {
            }
            column(NumberofNightaway_TransportRequest; "Transport Request"."Number of Night away")
            {
            }
            ...
            dataitem("Travelling Employee"; "Travelling Employee")
            {
                ...
                column(EmployeeNo_TravellingEmployee; "Travelling Employee"."Employee No.")
                {
                }
                column(EmployeeName_TravellingEmployee; "Travelling Employee"."Employee Name")
                {
                }
