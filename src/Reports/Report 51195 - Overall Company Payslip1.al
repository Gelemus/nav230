report 51195 "Overall Company Payslip1"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Overall Company Payslip1.rdl';
                    ...
                    dataitem("Payslip Lines"; "Payslip Lines")
                    {
                        ...
                        dataitem("Payroll Lines"; "Payroll Lines")
                        {
                            ...
                            begin
                                ...
                                "Payroll Lines".Text := "Payroll Lines".Text;
                                //ICS AUG 2018
                                /*
    ...
    begin
        ...
        PayslipFooter := PayrollSetupRec."Payslip Message Footer";//ICS 2016
