report 51149 "Overall Company Payslip"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Overall Company Payslip.rdl';
            ...
            dataitem("Approval Entry"; "Approval Entry")
            {
                ...
                begin
                    ...
                    if i = 1 then begin
                        ...
                        ApprovedByCaption := 'Checked By: HR ADMIN:';
                    ...
                    if "Approval Entry"."Approver ID" <> "Approval Entry"."Approver ID" then
                        CurrReport.Skip;
                end;
            }
