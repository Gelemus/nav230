report 50121 "Tenant Summary Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Tenant Summary Statement.rdl';
    Caption = 'Tenant Summary Statement';
    ...
    var
        ...
        CustTrialBalanceCaptionLbl: Label 'Summary Statement';
        CurrReportPageNoCaptionLbl: Label 'Page';
        AmtsinLCYCaptionLbl: Label 'Amounts in LCY';
        inclcustentriesinperiodCaptionLbl: Label 'Only includes tenants with entries in the period';
