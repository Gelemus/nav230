report 50609 "Standard Sales - Quote 2"
{
    RDLCLayout = 'src/Layouts/Standard Sales - Quote 2.rdl';
    WordLayout = 'src/Layouts/Standard Sales - Quote 2.docx';
    Caption = 'Sales - Quote';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ConnectionNo_Header; Header."Connection No.")
            {
            }
            column(ChainageNo_Header; Header."Chainage No")
            {
            }
            column(AccountNo_Header; Header."Account No.")
            {
            }
    ...
    var
        ...
        // TempBlobWorkDescription: Record 
        // TempBlobCompanyLogo: Record Blob Storage Module temporary;
