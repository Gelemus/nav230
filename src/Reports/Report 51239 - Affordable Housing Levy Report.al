report 51239 "Affordable Housing Levy Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Affordable Housing Levy Report.rdl';
    ...
    dataset
    {
        dataitem(Periods; Periods)
        {
            ...
            {
                DataItemTableView = WHERE("Affordable Housing Levy" = FILTER(true));
                ...
                dataitem(Employee; Employee)
                {
                    ...
                    column(NationalID_Employee; Employee.PIN)
                    {
                    }
                    ...
                    column(Total; PeriodAmountArray[1] + PeriodAmountArray[2])
                    {
                    }
                    ...
                    begin
                        ...
                        // PeriodAmountArray [2] := ROUND((EmployeeRec."Amount (LCY)");

                        //Employer Amount
                        EmployeeRec.Reset;
                        EmployeeRec.Get(Employee."No.");
                        EmployeeRec.SetFilter("Period Filter", Periods."Period ID");
                        EmployeeRec.SetRange("ED Code Filter", "ED Definitions"."Employer ED Code");
                        EmployeeRec.CalcFields("Amount (LCY)");
                ...
                trigger OnAfterGetRecord()
                begin
                    TitleText := ' Affordable Housing Levy for ' + Periods.Description + ' - ' + gvAllowedPayrolls."Payroll Code";
                end;
            }
