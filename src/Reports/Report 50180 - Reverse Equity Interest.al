report 50180 "Reverse Equity Interest"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Reverse Equity Interest.rdl';
    ...
    dataset
    {
        dataitem("Payment Terms"; "Payment Terms")
        {
            ...
            begin
                ...
                END;
                GLEntry.SETRANGE(GLEntry."Investment Transaction Type",GLEntry."Investment Transaction Type"::"Interest Receivable");
