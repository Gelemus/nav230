report 50218 "Employee Imprest Statement1"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Employee Imprest Statement1.rdl';
            ...
            dataitem("Employee Ledger Entry"; "Employee Ledger Entry")
            {
                ...
                begin
                    ...
                    if PaymentHeader.Get("Employee Ledger Entry"."Document No.") then
                        if PaymentHeader."Payment Type" <> PaymentHeader."Payment Type"::"Cheque Payment" then
                            CurrReport.Skip;
                    ...
                    if ImprestSurrenderHeader.Get("Employee Ledger Entry"."Document No.") then
                        if ImprestHeader.Get(ImprestSurrenderHeader."Imprest No.") then
                            if (ImprestHeader.Type <> ImprestHeader.Type::Imprest) or (ImprestHeader.Type <> ImprestHeader.Type::"Board Allowance") then
                                CurrReport.Skip;
                end;
            }
        }
