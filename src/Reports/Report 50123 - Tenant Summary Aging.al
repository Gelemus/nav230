report 50123 "Tenant Summary Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Tenant Summary Aging.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            var
                DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
            begin
                //Customer.SETRANGE("Account Type","Account Type"::Tenant);
    ...
    var
        ...
        Customer_Summary_AgingCaptionLbl: Label 'Summary Aging';
