report 50106 "Released Letterl  Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Released Letterl  Report.rdl';

    dataset
    {
        dataitem(Registry; Registry)
        {
            DataItemTableView = ORDER(Ascending) WHERE("Document Type" = CONST("Released Letter"));
