report 50456 "Payment Journal Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Payment Journal Report.rdl';
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            column(FloatAmount_BankAccount; "Bank Account"."Float Amount")
            {
            }
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                RequestFilterFields = "External Document No.";
                ...
                column(Payee_BankAccountLedgerEntry; "Bank Account Ledger Entry".Payee)
                {
                }
                ...
                begin
                    ...
                    //"Bank Account Ledger Entry".CALCFIELDS("Bank Account Ledger Entry".Payee);
                end;
