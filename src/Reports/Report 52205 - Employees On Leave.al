report 52205 "Employees On Leave"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Employees On Leave.rdl';
    ...
    dataset
    {
        dataitem("HR Leave Application"; "HR Leave Application")
        {
            ...
            begin
                SetFilter("HR Leave Application"."Leave Start Date", '>%1|=%1', StartDate);
                SetFilter("HR Leave Application"."Leave End Date", '<%1|=%1', EndDate);
