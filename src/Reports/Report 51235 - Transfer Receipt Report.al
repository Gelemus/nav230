report 51235 "Transfer Receipt Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Transfer Receipt Report.rdl';
    ...
    dataset
    {
        dataitem("Transfer Receipt Header"; "Transfer Receipt Header")
        {
            ...
            column(AssignedUserID_TransferReceiptHeader; "Transfer Receipt Header"."Assigned User ID")
            {
            }
            column(ReceivedBy_TransferReceiptHeader; "Transfer Receipt Header"."Received By")
            {
            }
            column(DateReceived_TransferReceiptHeader; "Transfer Receipt Header"."Date Received")
            {
            }
            ...
            begin
                ...
                UserSetupRec.SetRange("User ID", "Transfer Receipt Header"."Received By");
