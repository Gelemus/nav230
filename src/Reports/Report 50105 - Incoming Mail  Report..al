report 50105 "Incoming Mail  Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Incoming Mail  Report.rdl';

    dataset
    {
        dataitem(Registry; Registry)
        {
            DataItemTableView = ORDER(Ascending) WHERE("Document Type" = CONST("Incoming Letters"));
