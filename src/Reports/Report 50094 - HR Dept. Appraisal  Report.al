report 50094 "HR Dept. Appraisal  Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/HR Dept. Appraisal  Report.rdl';

    dataset
    {
        dataitem("HR Employee Appraisal Header"; "HR Employee Appraisal Header")
        {
            dataitem("Departmental Appraisal Lines"; "Departmental Appraisal Lines")
            {
