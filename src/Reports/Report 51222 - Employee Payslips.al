report 51222 "EmployeePayslips"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Employee Payslips.rdl';
        ...
        dataitem(Periods; Periods)
        {
            ...
            dataitem(Employee; Employee)
            {
                            ...
                            begin
                                ...
                                case EDDefRec."Calculation Group" of
                                    ...
                                    EDDefRec."Calculation Group"::None:
                                        begin
                                            if "Payslip Lines".Negative then begin
                                                "Payroll Lines"."Amount (LCY)" := -"Payroll Lines"."Amount (LCY)"
                                            end else
                                                "Payroll Lines"."Amount (LCY)" := "Payroll Lines"."Amount (LCY)";
                                            //"Payroll Lines"."Amount (LCY)" := "Payroll Lines"."Amount (LCY)";}
                ...
                begin
                    ...
                    if gvEmployeeNoFilter <> '' then SetRange("No.", gvEmployeeNoFilter);//FRS112819
                end;
            }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                field(gvEmployeeNoFilter; gvEmployeeNoFilter)
                {
                    Caption = 'Employee No.';
                    TableRelation = Employee;
                }
                field(gvPeriodIDFilter; gvPeriodIDFilter)
                {
    ...
    begin
        ...
        PeriodRec.SetRange("Payroll Code", gvPayrollCode2);
        PeriodRec.Find('-');
    ...
    var
        ...
        NonpayrollReceipts: Record "Non payroll Receipt";
