report 50613 "Casual Payment PV Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Casual Payment PV Report.rdl';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Cheque Type") ORDER(Ascending) WHERE(Status = FILTER(Approved), Select = FILTER(true));
