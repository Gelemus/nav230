...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Request for Quatation Report.rdl';
    ...
    dataset
    {
        dataitem("Request for Quotation Header"; "Request for Quotation Header")
        {
            ...
            dataitem("Request for Quotation Vendors"; "Request for Quotation Vendors")
            {
                DataItemLink = "RFQ Document No." = FIELD("No.");
                ...
                column(VendorEmailAddress_RequestforQuotationVendors; "Request for Quotation Vendors"."Vendor Email Address")
                {
                }
                column(Address_RequestforQuotationVendors; "Request for Quotation Vendors".Address)
                {
                }
                column(TelephoneNo_RequestforQuotationVendors; "Request for Quotation Vendors"."Telephone No")
                {
                }
            }
        }
