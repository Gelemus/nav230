...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Inspection Report.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(PurchaseRequisition_PurchRcptHeader; "Purch. Rcpt. Header"."Purchase Requisition")
            {
            }
            ...
            dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
            {
                ...
                column(CrossReferenceTypeNo_PurchRcptLine; "Purch. Rcpt. Line"."Item Reference No.")
                {
                }
