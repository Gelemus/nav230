    ...
    dataset
    {
        dataitem("Payroll Header"; "Payroll Header")
        {
            ...
            begin
                ...
                gvTempExcelBuffer.AddColumn(lvEmployee."National ID", false, '', false, false, false, '', gvTempExcelBuffer."Cell Type"::Text);//A
                ...
                lvPayrollLines.SetFilter("ED Code", PayrollSetup."Gross Pay  Code");
                ...
                lvPayrollLines.SetFilter("ED Code", '=%1|=%2', PayrollSetup."Hazard ED Code", PayrollSetup."Special Duty ED Code");
                lvPayrollLines.CalcSums("Amount (LCY)");
