report 50103 "Released Cheque Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Released Cheque Report.rdl';

    dataset
    {
        dataitem(Registry; Registry)
        {
            DataItemTableView = ORDER(Ascending) WHERE("Document Type" = CONST("Cheque to Collect"));
