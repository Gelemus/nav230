report 50806 "Bank Account Reconciliation4"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Bank Account Reconciliation4.rdl';
        ...
        dataitem("Bank Account Statement"; "Bank Account Statement")
        {
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                begin
                    ...
                    if "Bank Account Ledger Entry"."Statement No." = '' then
                        CurrReport.Skip;

                    Evaluate(sNo2, "Bank Account Ledger Entry"."Statement No.");
                    if sNo2 <= sNo1 then
                        CurrReport.Skip;
                    // END;
                end;
                ...
                begin
                    ...
                    "Bank Account Ledger Entry".SetRange("Bank Account Ledger Entry"."Bank Account No.", BankAcc);//"Bank Account Statement"."Bank Account No.");
            ...
            begin
                ...
                //ERROR('Errror %1 %2 %3', StartDate1,StartDate2,StartDate3);
                ...
                if BankAccLedger.Find('-') then begin
                    repeat
                        /*IF (BankAccLedger."Statement Status" = BankAccLedger."Statement Status"::Closed) AND (BankAccLedger."Statement No." = '') THEN
                        BEGIN
                          //-----
                        END ELSE
                        BEGIN*/
