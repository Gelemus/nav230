report 50170 "Account Risk Classification"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Account Risk Classification.rdl';
    ...
    dataset
    {
        dataitem("Meeting Attendance"; "Meeting Attendance")
        {
            ...
            column(Repayment_LoansRegister; "Meeting Attendance"."Meeting Name")
            {
            }
            column(PrincipleArrears; "Meeting Attendance"."Meeting Name")
            {
            }
            column(InterestArrears; "Meeting Attendance"."Meeting Name")
            {
            }
            column(PenaltyArrears; "Meeting Attendance"."Meeting Name")
            {
            }
            column(LoanFeeArrears; "Meeting Attendance"."Meeting Name")
            {
            }
            column(TotalPastDue; "Meeting Attendance"."Meeting Name")
            {
            }
            ...
            column(GlobalDim1; "Meeting Attendance"."Meeting Name")
            {
            }
            column(RiskClassification; "Meeting Attendance"."Meeting Name")
            {
            }
            ...
            column(OverPayment; OverPayment)
            {
            }
            ...
            begin
                ...
                TakeOnDate:=060116D;
                    ...
                    OverPayment:=0;
                   // IF PrevClient"No."<>"Customer No." THEN BEGIN
                      CustLedger2.RESET;
                      CustLedger2.SETRANGE(CustLedger2."Customer No.","Meeting Date");
                      CustLedger2.SETRANGE(CustLedger2."Investment Transaction Type",CustLedger2."Investment Transaction Type"::"Equity Fair Value");
                      IF CustLedger2.FINDSET THEN BEGIN
                       REPEAT
                        CustLedger2.CALCFIELDS(CustLedger2.Amount);
                        OverPayment:=OverPayment + CustLedger2.Amount;
                       UNTIL CustLedger2.NEXT=0;
                      END;
                  //  END;
                  //  PrevClient"No.":="Customer No.";
    ...
    var
        ...
        ReportTitle: Label 'Project balances Reconciliation Risk Classification Report';
