report 50110 "GOODS RECEIVED NOTE"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/GOODS RECEIVED NOTE.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(UserSetupRec_SignatureI; TenantMedia.Content)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        column(Desc_PurchRcptLine; "Purch. Rcpt. Line"."Description 2")
                        {
                        }
            ...
            begin
                ...
                //updated on 13/4/2023 to add designation of the one who received the items
                Employee.Reset;
                Employee.SetRange("User ID", "Purch. Rcpt. Header"."User ID");
                if Employee.FindSet then begin
                    Designation := Employee."Job Title";

                    TenantMedia.Reset;
                    if Employee."Employee Signature".HasValue then begin
                        TenantMedia.Get(Employee."Employee Signature".MediaId);
