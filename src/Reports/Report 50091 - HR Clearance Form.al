report 50091 "HR Clearance Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/HR Clearance Form.rdl';
    ...
    dataset
    {
        dataitem("HR Employee Exit Interviews"; "HR Employee Exit Interviews")
        {
            ...
            column(DateOfSeparation; "HR Employee Exit Interviews"."Date Of Separation")
            {
            }
            ...
            column(EmployementDate; "HR Employee Exit Interviews"."Employement Date")
            {
            }
