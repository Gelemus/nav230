report 51203 "Generate P10 Report"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Payroll Header";"Payroll Header")
        {
            ...
            begin
                ...
                lvPayrollLines.SetRange("Payroll ID","Payroll Header"."Payroll ID");
                lvPayrollLines.SetRange("Employee No.","Payroll Header"."Employee no.");
                lvPayrollLines.SetFilter("ED Code",'=%1|=%2',PayrollSetup."NSSF ED Code",PayrollSetup."Pension ED Code");
                lvPayrollLines.CalcSums("Amount (LCY)");
                ...
                gvTempExcelBuffer.AddColumn(0,false,'',false,false,false,'',gvTempExcelBuffer."Cell Type"::Number);//AB
                ...
                lvPayrollLines.SetRange("Payroll ID","Payroll Header"."Payroll ID");
                lvPayrollLines.SetRange("Employee No.","Payroll Header"."Employee no.");
                lvPayrollLines.SetFilter("ED Code",'=%1',PayrollSetup."Insurance Relief ED");
                lvPayrollLines.CalcSums("Amount (LCY)");
