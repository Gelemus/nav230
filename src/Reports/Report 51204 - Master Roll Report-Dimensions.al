report 51204 "Master Roll Report-Dimensions"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Master Roll Report-Dimensions.rdl';
    ...
    dataset
    {
        dataitem(Periods; Periods)
        {
            ...
            dataitem(Employee; Employee)
            {
                ...
                RequestFilterFields = "No.", "Global Dimension 1 Code", "Shortcut Dimension 3 Code", Status;
                ...
                column(ShortcutDimension7Code_Employee; Employee."Global Dimension 2 Code")
                {
                }
                column(ShortcutDimension6Code_Employee; Employee."Global Dimension 1 Code")
                {
                }
