report 50104 "Deposited Cheque Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Deposited Cheque Report.rdl';

    dataset
    {
        dataitem(Registry; Registry)
        {
            DataItemTableView = ORDER(Ascending) WHERE("Document Type" = CONST("Cheque to deposit"));
