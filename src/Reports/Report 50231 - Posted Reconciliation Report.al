report 50231 "Posted Reconciliation Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/Posted Reconciliation Report.rdl';
    ...
    dataset
    {
        ...
        dataitem("Bank Account Statement"; "Bank Account Statement")
        {
            ...
            // column(BankAccountname_BankAccountStatement;"Bank Account Statement"."Bank Account name")
            // {
            // }
        }
