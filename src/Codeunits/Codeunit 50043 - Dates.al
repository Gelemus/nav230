codeunit 50043 Dates
{
    ...
    procedure DetermineAgeService3(DateOfBirth: Date; DateOfJoin: Date) AgeString: Text[45]
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
    ...
    begin
        if ((DateOfBirth <> 0D) and (DateOfJoin <> 0D)) then begin
            ...
            Years := retirementdate - DateOfJoin;
            Year := Years div 365;
            Months := Years mod 365;
            Month := Months div 30;
            AgeString := '%1  Years and #2## Months and #3## Days';
            AgeString := StrSubstNo(AgeString, Year, Month);
    ...
    procedure DetermineAgeServiceYear2(DateOfBirth: Date; DateOfJoin: Date) YearRemaining: Integer
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
    ...
    procedure DetermineAgeServiceMonth2(DateOfBirth: Date; DateOfJoin: Date) MonthRemaining: Integer
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
    ...
    procedure DetermineRetirementDate(DateOfBirth: Date; DateOfJoin: Date) ReturnRetirementDate: Date
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
    ...
    begin
        if ((DateOfBirth <> 0D) and (DateOfJoin <> 0D)) then begin
            ...
            ReturnRetirementDate := retirementdate;
