    ...
    fields
    {
        ...
        field(4;"Net Pay Account No";Code[20])
        {
            TableRelation = IF ("Net Pay Account Type"=CONST("G/L Account")) "G/L Account"
                            ELSE IF ("Net Pay Account Type"=CONST(Customer)) Customer
                            ELSE IF ("Net Pay Account Type"=CONST(Vendor)) Vendor
                            ELSE IF ("Net Pay Account Type"=CONST("Bank Account")) "Bank Account";
        }
    }
