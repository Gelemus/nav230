table 50018 "Budget Control Setup"
{
    ...
    fields
    {
        ...
        field(5;"Budget Dimension 1 Code";Code[50])
        {
            Caption = 'Budget Dimension 1 Code';
            TableRelation = Dimension;
        }
        field(6;"Budget Dimension 2 Code";Code[50])
        {
        ...
        field(8;"Budget Dimension 4 Code";Code[50])
        {
            Caption = 'Budget Dimension 4 Code';
            TableRelation = Dimension;
        }
        field(9;"Budget Dimension 5 Code";Code[50])
        {
            Caption = 'Budget Dimension 5 Code';
            TableRelation = Dimension;
        }
        field(10;"Budget Dimension 6 Code";Code[50])
        {
            Caption = 'Budget Dimension 6 Code';
            TableRelation = Dimension;
        }
        field(11;"Analysis View Code";Code[50])
        {
            TableRelation = "Analysis View".Code;
        }
        field(12;"Dimension 1 Code";Code[50])
        {
            Caption = 'Dimension 1 Code';
            TableRelation = Dimension;
        }
        field(13;"Dimension 2 Code";Code[50])
        {
            Caption = 'Dimension 2 Code';
            TableRelation = Dimension;
        }
        field(14;"Dimension 3 Code";Code[50])
        {
            Caption = 'Dimension 3 Code';
            TableRelation = Dimension;
        }
        field(15;"Dimension 4 Code";Code[50])
        {
