table 50037 "FD Processing"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20])
        {
            ...
            begin
                if "Document No." <> xRec."Document No." then begin
                    ObjFDProcessing.Get;
                    NoSeriesMgt.TestManual(ObjSaccoSetup."Payment Voucher Nos.");
                    "Fixed Deposit Nos" := '';
                end;
            end;
        }
        ...
        {
            TableRelation = "Bank Account"."No." WHERE("Bank Account Type" = FILTER(Normal));
        ...
        field(68048; "FD Amount"; Decimal)
        {
            ...
            begin
                ...
                "Interest rate":=interestCalc."Interest Rate";
                FDDuration:=interestCalc."No of Months";
                "Expected Interest On Term Dep":=ROUND((("FD Amount"*"Interest rate"/100)/12)*FDDuration,0.01,'=');
                "Expected Interest On Term Dep":="Expected Interest On Term Dep"-("Expected Interest On Term Dep"*(GenSetUp."W/Tax Rounding Precision"/100));
                IF ("FD Amount"<interestCalc."Minimum Amount") OR ("FD Amount">interestCalc."Maximum Amount") THEN
        ...
        field(68055; "Fixed Duration"; DateFormula)
        {
            ...
            begin
                ...
                "Expected Interest On Term Dep" := Round(("FD Amount" * "Interest rate" / 100), 0.01, '=');
                /*
                IF "Account Type"='FIXED' THEN BEGIN
                interestCalc.RESET;
                interestCalc.SETRANGE(interestCalc.Code,"Fixed Deposit Type");
        ...
        {
            TableRelation = "Bank Account"."No." WHERE("Bank Account Type" = FILTER("Fixed Deposit"));
    ...
    begin
        if "Document No." = '' then begin
            ObjSaccoSetup.Get;
            ObjSaccoSetup.TestField(ObjSaccoSetup."Payment Voucher Nos.");
            NoSeriesMgt.InitSeries(ObjSaccoSetup."Payment Voucher Nos.", xRec."Document No.", 0D, "Document No.", "Fixed Deposit Nos");
        end;
    end;
    ...
    var
        ...
        ObjSaccoSetup: Record "Funds General Setup";
