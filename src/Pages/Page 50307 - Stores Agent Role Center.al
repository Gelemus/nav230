page 50307 "Stores Agent Role Center"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                ShowCaption = false;
                part(Control1907662708; "Stores Agent Activities")
                {
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("Inventory Management")
            {
                ...
                action("Open Store Requisitions List")
                {
                    Caption = 'Open Store Requisitions List';
                    RunObject = Page "Store Requisitions List";
                }
                action(" Store Requisitions Pending Approval")
                {
