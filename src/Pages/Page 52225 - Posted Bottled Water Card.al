page 52225 "Posted Bottled Water Card"
{
    Caption = 'Posted Value Addition Card';
    DeleteAllowed = false;
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part("Value Addition Line"; "Bottled Water Line")
            {
                ...
                action("Print Store Requisition")
                {
                    ...
                    begin
                        ...
                        if StoreRequisitionHeader.FindFirst then begin
                            REPORT.RunModal(REPORT::"Value Addition Report", true, false, StoreRequisitionHeader);
                        end;
                    end;
                }
            }
