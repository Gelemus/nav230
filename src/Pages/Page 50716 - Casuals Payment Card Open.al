page 50716 "Casuals Payment Card Open"
{
    DeleteAllowed = false;
    PageType = Card;
    ShowFilter = false;
    ...
    layout
    {
        area(content)
        {
            ...
            part("Casuals Daily Worksheet"; "Casuals Daily Wk Line Open")
            {
            ...
            part("Casuals Payment Line"; "Casuals Payment Line Open")
            {
                SubPageLink = "Document No." = FIELD("No."),
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        FundsManagement.CheckCasualPaymentMandatoryFields(Rec, false);
    ...
    begin
        ...
        END;
        */
        Rec.Type := Rec.Type::"Casuals Payment";
