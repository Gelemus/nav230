page 50361 "Grievance Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Grievance Details")
            {
                ...
                field("Grievance Type"; Rec."Grievance Type")
                {
                }
                field("Grievance About Management"; Rec."Grievance About Management")
                {
                }
                field("Grievance About HR Manager"; Rec."Grievance About HR Manager")
                {
                }
    ...
    begin
        Rec.Category := Rec.Category::Grievance;
    end;
