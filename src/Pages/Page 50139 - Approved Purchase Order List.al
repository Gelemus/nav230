page 50139 "Approved Purchase Order List"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Purchase Orders';
    CardPageID = "Approved Purchase Orders";
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        IF ApplicationAreaMgmtFacade.IsFoundationEnabled THEN
                          LinesInstructionMgt.PurchaseCheckAllLinesHaveQuantityAssigned(Rec);*///mesh
