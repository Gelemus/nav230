page 50691 "Approved Casual Payment List"
{
    CardPageID = "Approved Casuals Payment Card";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    ...
    SourceTableView = WHERE(Posted = CONST(false),
                            ...
                            "Casual Payment Paid" = FILTER(false));
        ...
        area(creation)
        {
            ...
            action("Clear Selected")
            {
                ...
                begin
                    ...
                    Rec.TestField(Status, Rec.Status::Approved);
                    ImprestHeader.Reset;
                    ImprestHeader.SetRange(Select, true);
            ...
            action("Print Casual Payments - PV")
            {
                Image = Print;
                Promoted = true;
                PromotedCategory = Process;
                ...
                begin
                    ...
                    if ImprestHeader.FindFirst then begin
                        REPORT.RunModal(REPORT::"Casual Payment PV Report", true, false, ImprestHeader);
                    end;
                end;
            }
    ...
    begin
        ...
        if not UserSetup."View Imprest" then
            Rec.SetFilter("User ID", UserSetup."User ID");
    end;
    ...
    var
        ...
        TEXT_004: Label 'Document Successfully Selection Cleared';
