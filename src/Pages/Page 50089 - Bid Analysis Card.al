            ...
            group(RequestApproval)
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        IF ApprovalsMgmt.CheckBidAnalysisApprovalsWorkflowEnabled(Rec) THEN
                          ApprovalsMgmt.OnSendBidAnalysisForApproval(Rec);
                          */
                ...
                action(CancelApprovalRequest)
                {
                    ...
                    begin
                        /*ApprovalsMgmt.OnCancelBidAnalysisApprovalRequest(Rec);
