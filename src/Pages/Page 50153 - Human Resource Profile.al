    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("Leave Management")
            {
                ...
                {
                    Caption = 'Posted Leave Reimbursements List';
                ...
                {
                    Caption = 'Leave Allowance Requests List';
            ...
            group("Performace Management")
            {
                ...
                action("HR Employee Appraisals Pending")
                {
                    Caption = 'HR Employee Appraisals Pending';
                    RunObject = Page "HR Employee Appraisals Pending";
                }
                action("HR Employee Appraisals Approved")
                {
                    Caption = 'HR Employee Appraisals Approved';
                    RunObject = Page "HR Employee Appraisals Approve";
                    ToolTip = 'HR Employee Appraisals Approved';
                }
                action("Human Resource Closed Employee Appraisals")
                {
                    Caption = 'Closed Employee Appraisals';
                    RunObject = Page "HR Employee Appraisals";
                    ToolTip = 'Human Resource Closed Employee Appraisals';
                }
                action("Human Resource Global Appraisal Objectives")
                {
                    Caption = 'Global Appraisal Objectives';
            ...
            group("Training Management")
            {
                ...
                {
                    Caption = 'HR Approved Training Need List';
