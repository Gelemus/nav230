page 51336 "Employee Role Centre"
{
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            group(Control81)
            {
                ...
                part(Control100; "Headline RC Team Member")
                {
                    ApplicationArea = Suite;
                }
                part(Control99; "Team Member Activities")
                {
                    ApplicationArea = Suite;
                }
    ...
    actions
    {
        area(sections)
        {
            ...
            group("Employee Self Service")
            {
                ...
                {
                    Caption = 'Status Purchase Requisition';
                ...
                action("Casual Requisitions Status")
                {
                    Caption = 'Casual Requisitions Status';
                    RunObject = Page "Casual Requisitions Status";
                }
                ...
                action("Casual Payment List - Status")
                {
                    Caption = 'Casual Payment List - Status';
                    RunObject = Page "Status Casual Payment List";
                }
        ...
        area(embedding)
        {
            ...
            action("Purchase Requisition List Status")
            {
                Caption = 'Purchase Requisition List Status';
                RunObject = Page "Purchase Requisition List S";
            }
            action(Action24)
            {
