page 50306 "Submitted Sales Quote"
{
    Caption = 'Sales Quote';
    Editable = false;
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Existing Connections"; Rec."Existing Connections")
                {
                }
            ...
            {
                ApplicationArea = Basic, Suite;
                Editable = (Rec."Sell-to Customer No." <> '') OR (Rec."Sell-to Customer Templ. Code" <> '') OR (Rec."Sell-to Contact No." <> '');
                Enabled = (Rec."Sell-to Customer No." <> '') OR (Rec."Sell-to Customer Templ. Code" <> '') OR (Rec."Sell-to Contact No." <> '');
