page 52223 "Bottled Water Card"
{
    Caption = 'Value Addition Card';
    DeleteAllowed = false;
    PageType = Document;
    ...
    actions
    {
        area(processing)
        {
            ...
            {
                Caption = 'Posting';
                action("Post Bottled Water")
                {
                    Caption = 'Post Value Addition';
                    Image = Payment;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Post Bottled Water';
