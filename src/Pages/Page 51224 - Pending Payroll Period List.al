page 51224 "Pending Payroll Period List"
{
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(Approvals)
            {
                ...
                RunPageView = WHERE("Document Type" = CONST(Payroll));
                ...
                begin
                    //WorkflowsEntriesBuffer.RunWorkflowEntriesPage(RECORDID,DATABASE::Periods,DocType::Payroll,"Period ID"+'-'+"Payroll Code");
                end;
            }
