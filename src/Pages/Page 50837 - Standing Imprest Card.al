    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Date"; Rec."Date From")
                {
                }

                field(Subject; Rec.Description)
                {
                    ToolTip = 'Specifies the field name';
                }
                ...
                // field("More Details"; Rec."More Details")
                // {
                // }
        ...
        area(processing)
        {
            group("Request Approval")
            {
                ...
                action(CommitBudget)
                {
                    ...
                    trigger OnAction()
                    begin
                        // if FundsManagement.commitGLBudget(Rec) then
            ...
            group(Approval)
            {
                ...
                action(Approve)
                {
                    ...
                    begin
                        if Confirm('Are you sure you want to Approve the Request?', true) then begin
                            ...
                            CurrPage.Close;//SETSELECTIONFILTER(RECORDID);
                        end;
                    end;
                }
                action(Reject)
                ...
                action(Delegate)
                {
                    ...
                    var
                        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
                    begin
                        if Confirm('Are you sure you want to Approve the Delegate?', true) then begin
