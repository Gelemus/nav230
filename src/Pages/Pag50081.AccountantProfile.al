...
page 50081 "Accountant Profile"
{
    Caption = 'Accountant Profile';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Employee List Finance';
                Image = Employee;
                RunObject = Page "Employee List Finance";
                ToolTip = 'View or edit detailed information for the Employees that you trade with. From each Employee card, you can open related information, such as sales statistics and ongoing orders, and you can define special prices and line discounts that you grant if certain conditions are met.';
            }
            action(Vendors)
            {
                ApplicationArea = Basic, Suite;
            ...
            action(Items)
            {
                ...
                ToolTip = 'View or edit inventory.';
            }
        ...
        area(sections)
        {
            ...
            group(Action172)
            {
                ...
                action("Funds General Setups")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Funds General Setups';
                    RunObject = Page "Funds General Setups";
                    ToolTip = 'Set up Funds General Setups, so that imprest, pettycash and payments can work.';
                }
                action("Funds Tax Codes")
                {
                    ...
                    ToolTip = 'Set up Funds General Setups, so that payments can work.';
                }
                action("Funds User Setup")
                {
                    ...
                    ToolTip = 'Set up Funds General Setups, so that funds mgt can work.';
                }
            ...
            group("Fund Management")
            {
                ...
                {
                    Caption = 'Pending Approval Petty Cash List';
