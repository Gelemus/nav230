page 50422 "Approved Withholding Lists"
{
    Caption = 'Payment List';
    CardPageID = "Approved Withholding Cards";
    DeleteAllowed = false;
    PageType = List;
            ...
            group(Posting)
            {
                ...
                action("Preview Posting")
                {
                    ...
                    begin
                        ...
                        if FundsUserSetup.Get(UserId) then begin
                            ...
                            FundsManagement.PostPaymentPortal(Rec, JTemplate, JBatch, true);
                        end else begin
                ...
                action("Post Withholding")
                {
                    ...
                    begin
                        ...
                        */
                        if FundsUserSetup.Get(UserId) then begin
                            FundsManagement.PostPaymentPortal(Rec, 'Payment', 'GWAITURU', false);
                        end;
