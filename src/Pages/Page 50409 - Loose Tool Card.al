page 50409 "Loose Tool Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control31; "Loose Tool Line")
            {
                ...
                action("Post Material  Requisition")
                {
                    ...
                    begin
                        ...
                        if InventoryUserSetup.Get(UserId) then begin
                            ...
                            InventoryManagement.PostLooseTools(Rec, JTemplate, JBatch);
                        end else begin
