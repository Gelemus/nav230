page 52276 "Online Repo Documents"
{
    DeleteAllowed = true;
    PageType = List;
    SourceTable = "Online Repo Documents";
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Import Attachment")
            {
                ...
                trigger OnAction()
                begin
                    FileManagement.UploadFile_OnlineRepDocs(Rec);
                end;
            }
            action(AttachedDoc)
            {
                ...
                begin
                    ...
                    PortalSetup.Get;
                    HyperLink(PortalSetup."Server File Path" + Rec."Actual File");
                end;
            }
        }
    }
