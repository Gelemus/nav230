page 50596 "Imprest List 2"
{
    CardPageID = "Imprest Card2";
    DeleteAllowed = false;
    PageType = List;
    ShowFilter = true;
    ...
    begin
        ...
        ImprestHeader.SetRange(ImprestHeader."Surrender status", ImprestHeader."Surrender status"::"Fully surrendered");
        if ImprestHeader.FindFirst then begin
            Error(Txt_002);
        end;
    end;
