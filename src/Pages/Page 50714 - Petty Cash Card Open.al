page 50714 "Petty Cash Card Open"
{
    DeleteAllowed = false;
    PageType = Card;
    ShowFilter = false;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control13; "Petty Cash Subform Open")
            {
                ...
                action("Print Petty Cash")
                {
                    ...
                    begin
                        ...
                        if ImprestHeader.FindFirst then begin
                            REPORT.RunModal(REPORT::"Petty Cash Voucher 1", true, false, ImprestHeader);
                        end;
                    end;
                }
            }
    ...
    begin
        ...
        Rec."Imprest Type" := Rec."Imprest Type"::Pettycash;
