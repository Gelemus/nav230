page 52249 "Project Implementation Card"
{
    DeleteAllowed = false;
    Editable = true;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Action Plan No"; Rec."Action Plan No")
                {
                }
                ...
                field("Contructor Notes"; Rec."Contructor Notes")
                {
                }
            ...
            part(Control11; "Project Implementataion Lines")
            {
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Project Implementation";
    end;
