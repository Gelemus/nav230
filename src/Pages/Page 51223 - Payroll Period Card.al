page 51223 "Payroll Period Card"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(Approvals)
            {
                ...
                begin
                    //WorkflowsEntriesBuffer.RunWorkflowEntriesDocumentPage(RECORDID,DATABASE::Period,"Document No");
                end;
            }
    ...
    var
        ...
        OverallCompanyPayslip: Report "Overall Company Payslip1";
